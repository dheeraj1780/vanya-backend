...
def _to_plant_item(plant: Plant) -> PlantItem:
    return PlantItem(
        ...
        regional_names=plant.regional_names or [],
        soil_type=plant.soil_type,
        soil_amendments=plant.soil_amendments,
...
async def create_plant(db: AsyncSession, user: User, plant_input: PlantInput) -> PlantItem:
    try:
        ...
        plant = await create_plant_repo(
            ...
            regional_names=plant_input.regional_names,
            soil_type=plant_input.soil_type,
            soil_amendments=plant_input.soil_amendments,
